                            ...
                            <Dropdown as="li" className="nav-item">
                                <Dropdown.Toggle as={CustomToggle} variant=" nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div className="caption ms-3 d-none d-md-block ">
                                        <h6 className="mb-0 caption-title text-capitalize">{user?.name} {user?.familyName}</h6>
                                        <p className="mb-0 caption-sub-title">{user?.jobTitle}</p>
                                    </div>
                                </Dropdown.Toggle>
                                <Dropdown.Menu  className="dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <Dropdown.Item href="/app/user-profile">Profile</Dropdown.Item>
                                    {/*<Dropdown.Item href="/app/user-privacy-setting">Privacy Setting</Dropdown.Item>*/}
                                    <Dropdown.Divider />
