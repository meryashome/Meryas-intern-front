                     ...
                     <div className="table-responsive">
                        <table id="user-list-table" className="table table-striped" role="grid" data-toggle="data-table">
                           ...
                           <tbody>
                           {
                              users?.map((item,idx) => (
                              <tr key={idx}>
                                 <td className="text-center"><Image className="bg-soft-primary rounded img-fluid avatar-40 me-3" src={item.avatar || shap1} alt="profile"/></td>
                                 <td>{item.name}</td>
                                 <td>{item.phoneNumber}</td>
                                 <td>{item.email}</td>
                                 <td>{item.cityOrTown}</td>
                                 <td><span className={`badge ${RoleColor(item.role)}`}>{item.role}</span></td>
                                 <td>{item.jobTitle}</td>
                                 <td>{item.jobStartDate.substring(0,10)}</td>
                                 <td>
